...
<html lang="en-GB">
  ...
  <body>
   ...
   <div class="container">
     <div id="body">
       <h2>Warn User</h2>
       <form method="post" action="/mod/api/warnUser.php">
         <label for="userId">User ID: </label>
         <input type="text" placeholder="Type here" name="userId" id="userId">
         <br>
         <label for="reason">Reason: </label>
         <input type="text" placeholder="Type here" name="reason" id="reason">
         <br>
         <input type="submit" value="Go!">
         <?php
      $succ = $_GET['succ'];
      if($succ=='true') {
        echo '<span class="text-green">User warned successfully</span>';
        }
      ?>
         </form>
    <?php
