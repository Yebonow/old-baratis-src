  ...
  <body>
   ...
   <div class="container">
     <div id="body">
       ...
       <form method="post" action="/admin/api/changeUsername.php">
         <label for="userId">User ID: </label>
         <input type="text" placeholder="Type here" name="userId" id="userId">
         <br>
         <label for="changeTo">New username: </label>
         <input type="text" placeholder="Type here" name="changeTo" id="changeTo">
         <br>
         <input type="submit" value="Go!">
         <?php
      $succ = $_GET['succ'];
      if($succ=='true') {
        echo '<span class="text-green">Username changed successfully</span>';
        }
      ?>
         </form>
    <?php
