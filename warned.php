  ...
  <body>
    ...
    <center>
      ...
      <div class="generic-box" style="width:800px">
        ...
        <p class="margin-top-0 margin-bottom-5">Your account has recieved a warning</p>
        <p class="margin-top-0 margin-bottom-5">Reason: <?php echo $_USER['warnReason']; ?></p>
        <p class="margin-top-0 margin-bottom-5">If you continue to break the rules, your account may be banned.</p>
        <p class="margin-top-0 margin-bottom-0"><a href="/api/acceptWarning.php"><button class="button button-green">Re-activate account</button></a></p>
      </div>
      </div>
     </center>
   </body>
